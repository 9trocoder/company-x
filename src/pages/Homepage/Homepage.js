...
function Homepage() {
  ...
  function setProductValue(value) {
    ...
    document.documentElement.style.setProperty("--productvalue", value);
  }
    ...
    <div className="homepagebody">
            ...
            <div className="hompage-productivity-item1">
              <div className="hompage-productivity-item1-left">
                ...
                <div className="dailygoalcoutn">
                  ...
                  <div className="dailygoalitemright">
                    <p>Tasks</p>
                  </div>
                </div>
                <p className="marks">
      ...
      <div className="bottomnav">
        <div className="bottomnav-item wherenav">
          ...
          <div className="bottomnavshow"></div>
        </div>
        ...
        <div className="bottomnav-itemhere">
          <svg
            width="15"
            height="15"
            viewBox="0 0 15 15"
